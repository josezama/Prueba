...
jQuery(document).ready(function($){
	...
	jQuery(".color2").click(function(){
		...
		$('.logo img').attr('src', 'img/Header/logo.png');
		$('.header-v2 .logo img').attr('src', 'img/Header/logo-invest.png');
		$('.footer-col-1 img').attr('src', 'img/Header/logo-invest.png');
	});
	
	jQuery(".color3").click(function(){
		jQuery("#colors").attr("href", "switcher/colors/green.css");
		$('.logo img').attr('src', 'img/Header/logo-green.png');
		$('.header-v2 .logo img').attr('src', 'img/Header/logo-green-invest.png');
		$('.footer-col-1 img').attr('src', 'img/Header/logo-green-invest.png');
	});
	...
	jQuery(".color5").click(function(){
		...
		$('.logo img').attr('src', 'img/Header/logo-orange.png');
		$('.header-v2 .logo img').attr('src', 'img/Header/logo-orange-invest.png');
		$('.footer-col-1 img').attr('src', 'img/Header/logo-orange-invest.png');
	});
	...
	jQuery(".color8").click(function(){
		...
		$('.logo img').attr('src', 'img/Header/logo-red.png');
		$('.header-v2 .logo img').attr('src', 'img/Header/logo-red-invest.png');
		$('.footer-col-1 img').attr('src', 'img/Header/logo-red-invest.png');
	});
	
	jQuery(".color9").click(function(){
		jQuery("#colors").attr("href", "switcher/colors/yellow.css");
		$('.logo img').attr('src', 'img/Header/logo-yellow.png');
		$('.header-v2 .logo img').attr('src', 'img/Header/logo-yellow-invest.png');
		$('.footer-col-1 img').attr('src', 'img/Header/logo-yellow-invest.png');
	});
	...
	jQuery(".color11").click(function(){
		...
		$('.logo img').attr('src', 'img/Header/logo-blue.png');
		$('.header-v2 .logo img').attr('src', 'img/Header/logo-blue-invest.png');
		$('.footer-col-1 img').attr('src', 'img/Header/logo-blue-invest.png');
	});
